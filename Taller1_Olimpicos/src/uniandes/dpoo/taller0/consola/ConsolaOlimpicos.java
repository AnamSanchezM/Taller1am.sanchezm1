...
public class ConsolaOlimpicos
{
	...
	/**
	 * Le pide al usuario el nombre de un atleta y luego le muestra la información del
	 * país al cual hace parte.
	 */
	private void ejecutarPaisAtleta ()
	{
		...
		{
			System.out.println("El atleta "+ atleta + " representa el país de: "+pais);
		}
	}
