...
public class CalculadoraEstadisticas
{
	...
	/** 
	 * Consulta cuál es el pais al que pertenece el atleta que se
	 * indico
	 * 
	 * 
	 * @param nombreAtleta El nombre del atlera de interés.
	 * @return Una cadena de texto tipo String con el nombre del país al que pertenece
	 *         el atleta. 
	 *         
	 */
